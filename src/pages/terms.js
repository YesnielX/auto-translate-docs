  ...
  return (
    <Layout>
      ...
      >
        ...
        <p>
          Welcome to <b>Auto Translate</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at{" "}
          <b>https://yesnielx.github.io/auto-translate-docs</b> (together or
          individually “Service”) operated by <b>Auto Translate</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>autotranslatebot@gmail.com</b> so we can try to find a solution.
        ...
        <p>
          Content found on or through this Service are the property of Auto
          Translate or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of Auto Translate and its licensors. Service is protected by
          ...
          without the prior written consent of Auto Translate.
        </p>
        <p>
        ...
        <p>
          ...
          to autotranslatebot@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You may provide us either directly at autotranslatebot@gmail.com or
        ...
        <p>
          ...
          that are not owned or controlled by Auto Translate.
        </p>
        <p>
          Auto Translate has no control over, and assumes no responsibility for
        ...
        <p>
          ...
          laws of Dominican Republic, which governing law applies to agreement
        ...
        <p>
          ...
          email: <b>autotranslatebot@gmail.com</b>.
        </p>
